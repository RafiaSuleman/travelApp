...
const Hero = () => {
  return (
    <section className="mx-auto max-w-[1440px] px-6 lg:px-20 flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20  ">
      <div
        style={{ backgroundImage: "url('/asserts/pattern-bg.png')" }}
        className="absolute right-0  h-screen w-screen bg-cover bg-center md:-right-28 md:top-10 xl:-top-10 xl:-right-50 top-85"
      />
      {/* upper absolute is lya k image normal layout sa nikl kr background ma chali jay  */}

      {/* LEFT */}
      {/* z-20 taka camp image background image sa upper rahy relative is lya taka iska andr absolute image position ho */}
      <div className="relative z-20 flex flex-1 flex-col  xl:w-1/2 px-4 lg:text-left">
        <Image
          ...
          height={50}
          width={50}
          className=" absolute left-[1px] lg:top-[-40px] top-[-29px] w-10 lg:w-[50px]"
        />
        <h1 className="text-7xl font-bold lg:text-8xl mt-1">
          {" "}
          Putuk Turno Hill Area{" "}
        </h1>
        <p className="mt-16 text-gray-500 xl:max-w-[520px]">
          {" "}
        ...
        <div className="my-11 flex flex-wrap items-center gap-5">
          ...
          <p className="text-bold text-blue-950 mr-2">
            {" "}
            198k
        ...
        <div className="relative flex flex-1 mb-4">
          <div className="absolute lg:-top-[150px] lg:right-70  xl:-top-[400px] xl:-right-[300px] flex  z-20 w-[268px]  flex-col xl:flex-row gap-8 rounded-3xl bg-green-950 px-7 py-8">
